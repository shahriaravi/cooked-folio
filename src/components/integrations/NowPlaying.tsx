...
const CACHE_KEY = "avi-spotify-cache";

function getCachedData(): SpotifyData | null {
  try {
...
function setCachedData(data: SpotifyData) {
  try {
...
export default function NowPlaying() {
  const [data, setData] = useState<SpotifyData | null>(getCachedData);
  ...
  useEffect(() => {
    const fetchNowPlaying = async () => {
      try {
        ...
        const fallback: SpotifyData = { isPlaying: false };
        setData(fallback);
